...
static void list_modules(list_context_t *context)
{
    size_t index;
...
static int cmd_ls(int argc, char **argv)
{
    ...
    context.is_module_directory = (strcmp(resolved, "/modules") == 0);
    ...
    if (context.is_module_directory) {
        list_modules(&context);
    }
    if (context.count == 0U) {
